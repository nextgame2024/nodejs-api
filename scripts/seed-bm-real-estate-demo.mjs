...
const knowledge = [
  ["renting", "What are the usual requirements to rent or apply for a property in Brisbane?", "Complete the Queensland Rental Application Form 22 and provide your contact, employment, income, rental-history, referee, intended-tenancy, household, vehicle and pet details. The agency may request up to two supporting documents in each category: identity, ability to pay rent and suitability for the tenancy.", "https://www.rta.qld.gov.au/before-renting/applying-for-a-rental-property/application-process"],
  ...
  ["renting", "What identity documents are commonly used for a rental application?", "Common identity documents include a driver licence, passport, birth certificate or another government identity document. An applicant can provide a copy or show the original; an agency needs consent to retain a copy of an original document it inspected in person.", "https://www.rta.qld.gov.au/before-renting/applying-for-a-rental-property/application-process"],
  ["renting", "What suitability documents or references can support a rental application?", "Common suitability evidence includes rental references, a rental ledger or tenancy history and referee contact details. Each applicant should complete their own application, and the agency will confirm which permitted documents it requests.", "https://www.rta.qld.gov.au/before-renting/applying-for-a-rental-property/application-process"],
  ["renting", "Does every person need to complete a rental application?", "When more than one person applies for the same property, each applicant can complete a separate Rental Application Form 22 and provide their own requested supporting information.", "https://www.rta.qld.gov.au/before-renting/applying-for-a-rental-property/application-process"],
  ["renting", "What information should I prepare about occupants, vehicles and pets?", "Prepare the number of adults and children who will live at the property, the number and type of vehicles to be kept there, and the number and type of pets you want approved. Form 22 also asks for the intended tenancy term.", "https://www.rta.qld.gov.au/before-renting/applying-for-a-rental-property/application-process"],
  ...
  ["selling", "What are the usual requirements and documents to sell a property in Brisbane?", "Start with proof of ownership and identity, property address and lot or plan details, and the Residential Agent Appointment Form 6 covering services, commission and marketing costs. For the sale, prepare the mandatory Seller Disclosure Statement Form 2 with current title and prescribed property certificates before the buyer signs the contract.", "https://www.qld.gov.au/housing/buying-owning-home/seller-disclosure-scheme"],
  ...
  ["selling", "What is the Queensland Seller Disclosure Statement Form 2?", "Form 2 records seller and property details and relevant title, encumbrance, tenancy, land-use, planning, environmental, building and structure information. It and the required certificates must be given to the buyer before the buyer signs the contract.", "https://www.qld.gov.au/housing/buying-owning-home/seller-disclosure-scheme"],
  ["selling", "Which certificates may be needed for Queensland seller disclosure?", "Depending on the property, prescribed documents may include a current title search and survey plan, applicable statutory notices, a pool safety certificate, and for community-title properties the community management statement and body corporate certificate.", "https://www.qld.gov.au/housing/buying-owning-home/seller-disclosure-scheme"],
  ["selling", "What information is recorded when appointing an agent to sell?", "Residential Agent Appointment Form 6 records the services the agent will provide, commission, advertising or other authorised expenses, payment timing, appointment period and appointment type.", "https://www.qld.gov.au/housing/buying-owning-home/selling-a-home/before-you-put-your-home-on-the-market/appointing-a-real-estate-sales-agent"],
