...
function drawDocumentIntro(doc, { document, company, client, project, logoBuffer }) {
  ...
  doc.fillColor(BRAND.text).font("Helvetica-Bold").fontSize(11).text("Billed to:", x, billedY);
  doc.fillColor(BRAND.text).font("Helvetica").fontSize(11).text(clientLines.join("\n"), x, billedY + 25, {
